...
import IdentificacaoContratos from './01_IdentificacaoContratos.jsx';
import CapacidadeEconomicoFinanceira from './02_CapacidadeEconomicoFinanceira.jsx';
import DPOPrivacidade from './03_DPOPrivacidade.jsx';
import IndicadoresContratuaisSLA from './04_IndicadoresContratuaisSLA.jsx';

const subPaginas = [
  { id: 'identificacao', label: 'Identificação & contratos', component: IdentificacaoContratos, badge: null },
  { id: 'capacidade', label: 'Capacidade econ.-financeira', component: CapacidadeEconomicoFinanceira, badge: null },
  { id: 'dpo', label: 'DPO & Privacidade', component: DPOPrivacidade, badge: { type: 'ember', text: '1' } },
  { id: 'sla', label: 'Indicadores contratuais & SLA', component: IndicadoresContratuaisSLA, badge: { type: 'rust', text: '3' } },
];
...
const menuPrincipal = [
  {
    ...
    itens: [
      { num: '01', label: 'Gestão da plataforma', active: false },
  ...
  },
  {
    ...
    itens: [
      { num: '09', label: 'Operadoras', active: true },
...
export default function TitanOperadoras() {
  const [active, setActive] = useState('identificacao');
  const [menuExpanded, setMenuExpanded] = useState(true);

  const ActiveComponent = subPaginas.find(s => s.id === active)?.component || subPaginas[0].component;
  ...
  return (
    <nav style={{
      ...
      <div style={{ padding: '0 20px', marginBottom: 16 }}>
        ...
        <div style={{ fontSize: 13, color: tokens.colors.ink, fontWeight: 500 }}>4 sub-páginas</div>
      </div>
      {subPaginas.map(s => (
        <button
          key={s.id}
