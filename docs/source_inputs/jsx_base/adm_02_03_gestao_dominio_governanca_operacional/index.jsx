...
import CatalogoVariaveis from './01_CatalogoVariaveis.jsx';
import EtapasTratamento from './02_EtapasTratamento.jsx';
import KPIsSetoriais from './03_KPIsSetoriais.jsx';
import RegrasIntegridade from './04_RegrasIntegridade.jsx';

const subPaginas = [
  { id: 'catalogo', label: 'Catálogo de variáveis', component: CatalogoVariaveis, badge: null },
  { id: 'etapas', label: 'Etapas de tratamento', component: EtapasTratamento, badge: null },
  { id: 'kpis', label: 'KPIs setoriais', component: KPIsSetoriais, badge: null },
  { id: 'regras', label: 'Regras de integridade', component: RegrasIntegridade, badge: { type: 'rust', text: '5' } },
];
...
const menuPrincipal = [
  {
    ...
    itens: [
      ...
      { num: '02', label: 'Gestão de domínio', active: true },
...
export default function TitanGestaoDominio() {
  const [active, setActive] = useState('catalogo');
  const [menuExpanded, setMenuExpanded] = useState(true);

  const ActiveComponent = subPaginas.find(s => s.id === active)?.component || CatalogoVariaveis;
